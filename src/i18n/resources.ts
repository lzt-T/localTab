...
export const resources = {
  "zh-CN": {
    translation: {
      ...
      popup: {
        subtitle: "新标签页管理器",
        quickBookmarkTitle: "收藏当前页面",
        loadingPage: "正在读取当前页面...",
        unsupportedPage: "当前页面无法收藏，请打开一个 HTTP 或 HTTPS 网页。",
        loadFailed: "读取当前页面失败，请重试。",
        retry: "重新读取",
        categoryLabel: "保存到分类",
        selectCategory: "请选择分类",
        noCategories: "还没有分类，创建一个分类后即可收藏。",
        createCategory: "创建新分类",
        createFirstCategory: "创建第一个分类",
        newCategoryPlaceholder: "输入分类名称",
        confirmCreate: "创建并选中",
        creatingCategory: "正在创建...",
        categoryCreated: "分类已创建",
        categoryCreateFailed: "分类创建失败，请重试",
        bookmark: "收藏当前页面",
        bookmarking: "正在收藏...",
        bookmarkSuccess: "已收藏到 LocalTab",
        alreadyBookmarked: "当前页面已存在于该分类",
        bookmarkFailed: "收藏失败，请重试",
        openNewTab: "打开新标签页",
  ...
  "en-US": {
    translation: {
      ...
      popup: {
        ...
        quickBookmarkTitle: "Save current page",
        loadingPage: "Reading current page...",
        unsupportedPage: "This page cannot be saved. Open an HTTP or HTTPS page.",
        loadFailed: "Could not read the current page. Try again.",
        retry: "Try again",
        categoryLabel: "Save to category",
        selectCategory: "Select a category",
        noCategories: "No categories yet. Create one to save this page.",
        createCategory: "Create category",
        createFirstCategory: "Create your first category",
        newCategoryPlaceholder: "Enter a category name",
        confirmCreate: "Create and select",
        creatingCategory: "Creating...",
        categoryCreated: "Category created",
        categoryCreateFailed: "Could not create the category. Try again",
        bookmark: "Save current page",
        bookmarking: "Saving...",
        bookmarkSuccess: "Saved to LocalTab",
        alreadyBookmarked: "This page is already in that category",
        bookmarkFailed: "Could not save this page. Try again",
