...
export default function Dock({
  ...
  return (
    <nav
      className="fixed bottom-4 left-1/2 z-40 flex -translate-x-1/2 items-center gap-1 rounded-2xl border border-white/15 bg-[rgba(20,22,26,0.72)] p-1.5 shadow-[0_18px_46px_rgba(0,0,0,0.38)] backdrop-blur-2xl md:bottom-6"
